...
function updateAngles(){
  ...
  //console.log("Theta Min = " + min + " Theta Max = " + max);
  ...
  //
  // }
    var diff1 = abs(max-min);
    print(diff1);
  pingPong.wet.value = map(diff1, 0 , 360, 0.05, 0.7 );
  sampler.volume.value = map(diff1, 0, 360, -20, 3);
...
if(points[2] && points[3]){
  //console.log("Theta Min = " + points[0].angle(spaceSize)*180/PI + " Theta Max = " + points[1].angle(spaceSize)*180/PI);
  var min2 = points[3].angle(spaceSize)*180/PI + 180;
  var max2 = points[2].angle(spaceSize)*180/PI + 180;
//  console.log("Theta Min2 = " + min2 + " Theta Max3 = " + max2);


  var diff2 = abs(max2-min2);
freeverb.wet.value = map(diff2, 0, 360, 0.0, 0.7);
sampler2.volume.value = map(diff2, 0, 360, -20, 3);
...
if(points[4] && points[5]){
  ...
  //console.log("Theta Min2 = " + min3 + " Theta Max3 = " + max3);
  //
  // if(min3 == 0){
  //   min3 = 0;
  //   max3 = 0;
  ...
  sampler3.volume.value = map(diff2, 0, 360, -20, 3);
